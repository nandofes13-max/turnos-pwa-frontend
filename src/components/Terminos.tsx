...
export default function Terminos() {
  ...
  return (
    <div className="tm-page" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      <h1 className="tm-titulo" style={{ marginBottom: '1.5rem' }}>Términos y Condiciones de Uso</h1>
      ...
      <div style={{ lineHeight: '1.8', color: '#374151' }}>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>1. Objeto del servicio</h2>
        <p>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>2. Uso de la plataforma</h2>
        <p>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. Responsabilidad del usuario</h2>
        <p>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>4. Responsabilidad del servicio</h2>
        <p>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>5. Disponibilidad</h2>
        <p>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>6. Propiedad intelectual</h2>
        <p>
        ...
        <h2 style={{ marginTop: '1.5rem', marginBottom: '0.5rem' }}>7. Modificaciones</h2>
        <p>
